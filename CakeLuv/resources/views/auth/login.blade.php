...
<div class="bg-secondary min-h-screen flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full" data-aos="fade-up">
        ...
        <div class="text-center mb-10">
            <h2 class="text-3xl font-serif font-bold text-dark mb-2">Selamat Datang Kembali</h2>
            <p class="text-gray-500 font-light">Masuk untuk melihat pesanan dan penawaran eksklusif Anda.</p>
        </div>
        ...
        <div class="bg-white py-10 px-8 rounded-3xl shadow-2xl border border-gray-100">
            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" required class="appearance-none w-full px-5 py-4 rounded-xl border border-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all font-light text-sm" placeholder="••••••••">
                    </div>
                    ...
                    <button type="submit" class="w-full bg-primary hover:bg-primary_hover text-white font-bold py-4 px-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 tracking-wider uppercase text-sm">
                        Masuk Sekarang
                    </button>
                </div>
            </form>
            ...
            <div class="mt-8 text-center border-t border-gray-100 pt-6">
                <p class="text-sm text-gray-600 font-light">
                    Belum punya akun? 
                    <a href="{{ url('/register') }}" class="font-bold text-primary hover:text-primary_hover transition-colors">Daftar di sini</a>
                </p>
            </div>
        </div>
    </div>
